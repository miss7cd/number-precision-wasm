(module
 ...
 (global $~lib/memory/__data_end i32 (i32.const 656))
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 33424))
 (global $~lib/memory/__heap_base i32 (i32.const 33424))
 (memory $0 1)
 ...
 (data $10 (i32.const 492) "<\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00*\00\00\00O\00b\00j\00e\00c\00t\00 \00a\00l\00r\00e\00a\00d\00y\00 \00p\00i\00n\00n\00e\00d\00\00\00")
 (data $11 (i32.const 556) "<\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00(\00\00\00O\00b\00j\00e\00c\00t\00 \00i\00s\00 \00n\00o\00t\00 \00p\00i\00n\00n\00e\00d\00\00\00\00\00")
 (data $12 (i32.const 624) "\07\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00\02\1a\00\00\02\01\00\00\02\t\00\00")
 (table $0 1 1 funcref)
 (elem $0 (i32.const 1))
 ...
 (export "plus" (func $export:assembly/index/plus@varargs))
 (start $~start)
 ...
 (func $assembly/index/decimalLength (param $num f64) (result i32)
  (local $e i32)
  (local $count i32)
  i32.const 1
  local.set $e
 ...
 (func $assembly/index/pow10 (param $n i32) (result f64)
  (local $res f64)
  (local $i i32)
  f64.const 1
  local.set $res
       ...
       block $~lib/string/String
        block $~lib/arraybuffer/ArrayBuffer
         block $~lib/object/Object
          ...
          i32.sub
          i32.load
          br_table $~lib/object/Object $~lib/arraybuffer/ArrayBuffer $~lib/string/String $~lib/arraybuffer/ArrayBufferView $~lib/array/Array<f64> $~lib/array/Array<usize> $~lib/array/Array<i32> $invalid
         end
         return
        end
        return
 ...
 (func $assembly/index/plusEx (param $arr i32) (param $len i32) (result f64)
  (local $maxDecimal i32)
  (local $i i32)
  (local $d i32)
  (local $base f64)
  (local $sum f64)
  ...
  loop $for-loop|0
   ...
   if
    ...
    local.get $i
    call $~lib/array/Array<f64>#__get
    call $assembly/index/decimalLength
    local.set $d
    local.get $d
    local.get $maxDecimal
    i32.gt_s
    if
     local.get $d
     local.set $maxDecimal
 ...
 (func $assembly/index/plus (param $arr i32) (result f64)
  (local $1 i32)
  (local $2 f64)
  global.get $~lib/memory/__stack_pointer
  i32.const 8
 ...
 (func $assembly/index/plus@varargs (param $arr i32) (result f64)
  (local $1 i32)
  (local $2 i32)
  (local $3 f64)
  global.get $~lib/memory/__stack_pointer
 ...
 (func $export:assembly/index/plus@varargs (param $0 i32) (result f64)
  (local $1 f64)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
  ...
  i32.store
  local.get $0
  call $assembly/index/plus@varargs
  local.set $1
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.add
