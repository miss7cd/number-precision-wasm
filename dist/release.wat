(module
 ...
 (data $11 (i32.const 1616) "\05\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00\02\1a")
 ...
 (export "plus" (func $export:assembly/index/plus))
 (export "minus" (func $export:assembly/index/minus))
 (export "times" (func $export:assembly/index/times))
 (export "divide" (func $export:assembly/index/divide))
 ...
 (func $assembly/index/plus (param $0 i32) (param $1 i32) (result f64)
  (local $2 f64)
  (local $3 f64)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $assembly/index/minus (param $0 i32) (param $1 i32) (result f64)
  (local $2 f64)
  (local $3 f64)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $assembly/index/times (param $0 i32) (param $1 i32) (result f64)
  (local $2 f64)
  (local $3 f64)
  (local $4 f64)
  (local $5 i32)
 ...
 (func $assembly/index/divide (param $0 i32) (param $1 i32) (result f64)
  (local $2 f64)
  (local $3 f64)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $export:assembly/index/plus (param $0 i32) (param $1 i32) (result f64)
  (local $2 f64)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
 ...
 (func $export:assembly/index/minus (param $0 i32) (param $1 i32) (result f64)
  (local $2 f64)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
  ...
  local.get $0
  local.get $1
  call $assembly/index/minus
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.add
  global.set $~lib/memory/__stack_pointer
 )
 (func $export:assembly/index/times (param $0 i32) (param $1 i32) (result f64)
  (local $2 f64)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
  ...
  local.get $0
  local.get $1
  call $assembly/index/times
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.add
  global.set $~lib/memory/__stack_pointer
 )
 (func $export:assembly/index/divide (param $0 i32) (param $1 i32) (result f64)
  (local $2 f64)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
 ...
 (func $export:assembly/index/average (param $0 i32) (param $1 i32) (result f64)
  (local $2 f64)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
  ...
  block $folding-inner0
   ...
   i32.const 0
   i32.store
   block $__inlined_func$assembly/index/average$145
    local.get $1
    i32.const 0
    i32.le_s
    br_if $__inlined_func$assembly/index/average$145
    local.get $1
    i32.const 1
    i32.eq
    if
     ...
     call $~lib/array/Array<f64>#__get
     local.set $2
     br $__inlined_func$assembly/index/average$145
    end
    global.get $~lib/memory/__stack_pointer
    local.get $0
    i32.store
